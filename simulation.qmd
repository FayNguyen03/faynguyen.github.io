...
While we evaluate the effect of these factors on the power, we will consider  intercept at 0.8. Power is usually set at 80%. This means that if there are true effects to be found in 100 different studies with 80% power, only 80 out of 100 statistical tests will actually detect them
...
From the graph, we can see that the higher the true difference, the higher the power is.   
